...
//ToDo
//applicationUrl under launchSettings.json should be possible to read
const uri = 'https://localhost:7241/GymClasses/FetchForm';
...
function fetchCreateForm() {
    fetch('https://localhost:7241/GymClasses/FetchForm', {
        method: 'GET',
        headers: {
